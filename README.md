...
RAG-система для вопросов по загруженным PDF, Markdown и TXT. Ответ строится только из найденных фрагментов корпуса. Если релевантного контекста нет, модель не додумывает — возвращается фиксированный отказ.
